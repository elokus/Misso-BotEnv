...
class PosWave(PosLive):
    ...
    curr_fwaves: list = field(default_factory=list)
    ...
    def update_wave_range(self, reviews: dict):
        ...
        self.curr_fwaves = review[self.curr_tx]["filtered_waves"]
    ...
    def get_wave_pairs(self, target_by: str, target_factor: float):
        wps = utils.get_wave_pairs(self.curr_waves, target_by, self.curr_fwaves)
